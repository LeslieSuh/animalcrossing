...
const languages = ["usen", "jpja", "frfr", "krko"];
const languageSet = {
  en: ["Language", "Search", "English", "Japanese", "French", "Korean"],
  ja: ["言語", "探す", "英語", "日本語", "フランス語", "韓国語"],
  fr: ["Langue", "Chercher", "Anglais", "japonais", "français", "coréen"],
  ko: ["언어", "검색", "영어", "일본어", "일본어", "프랑스어", "한국어"],
};
...
searchName.addEventListener("keyup", function () {
  if (searchName.value) {
    const filtered = words.filter((element) => matchSearch(element));
  }
});
